...
Here are the original images of the examples on which the different strategies are applied.

The first image represents an example of visualization which contains boxes with labels above generated by roassal and the second image is a list of all the classes of the system built by spec2.
<p float="left">
  <img src="images/roassalExamples/originalVisualization.png" width="1200" />
